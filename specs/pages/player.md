...
The Player page is the video playback interface for GCashTV. It features a video player with custom controls, episode information, an episode list sidebar, and recommendation carousels. Users can add series to favorites, track watch history, and share content on social media.

This document explains the Player page in a way that everyone can understand, including designers, product managers, QA, business stakeholders, and engineers.
...
The Player page uses URL parameters to navigate:

- `/player/:seriesId` - Opens the series starting at episode 1
- `/player/:seriesId/:episodeId` - Opens a specific episode
...
- tags: list of genres or categories
- language: primary language
- episodes: list of episodes
- poster: main series image

### Recommended Series
Each recommended series includes:
- id: unique identifier
- title: series title
- poster: series image
- tag: primary genre or category
...
- Width: 100vw
- Height: 100vh
- Video Object Fit: contain (fit video within screen)
...
- Two sections: You Might Like and New Releases
- Each shows series recommendations excluding the current series
- Uses shared series list component
...
### LanguageContext
- t: Translation object for internationalization
...
- Reset episode to 1 if no episodeId is provided
...
### Series Database
- 17 series entries (featured-1, 1-16)
- Titles, descriptions, tags array, poster URLs
