...
export const en = {
  ...
  quickCreate: {
    ...
    step2: {
      heading: 'Choose a genre',
      subtitle: 'This helps AI craft the right kind of story.',
      genres: {
        action: 'Action',
        romance: 'Romance',
        fantasy: 'Fantasy',
    ...
    step3: {
      heading: 'Choose an art style',
      subtitle: 'Pick the look and feel of your anime.',
      styles: {
    ...
    step4: {
      heading: 'Choose episode length',
      subtitle: 'Each episode will have this duration.',
      seconds: 'seconds',
      desc30: 'Perfect for short and fast-paced stories',
      desc60: 'More time for deeper story and emotions',
    },
    step5: {
      heading: "Let's review your series",
      subtitle: "Here's the complete anime plan for you.",
      ...
      seriesPlanValue: '{count} Episodes (Mini-Series)',
      directorSays: 'AI Director says:',
      directorNote:
        "I've created a {count}-episode mini-series with an exciting story arc and cliffhangers to keep your audience hooked!",
